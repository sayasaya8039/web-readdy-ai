    ...
    <div class="w-96 bg-white border-l border-slate-200 flex flex-col">
      ...
      <div id="chat-content" class="flex-1 flex flex-col">
        ...
        <div class="p-4 border-t border-slate-200">
          <!-- 入力フィールド -->
          <input type="text" id="prompt-input" placeholder="ページョン1" class="w-full px-4 py-3 text-sm rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-500 mb-3" />
